package com.hemu.html.adopters;
...
public class ShortsAdopters extends PagerAdapter {
    ...
    public Object instantiateItem(@NonNull ViewGroup container, int position) {
        View itemView = layoutInflater.inflate(R.layout.item_shorts,container,false);
        ...
        textView2.setOnClickListener(v -> {
            Intent linkOpen = new Intent(Intent.ACTION_VIEW, Uri.parse(links.get(position)));
