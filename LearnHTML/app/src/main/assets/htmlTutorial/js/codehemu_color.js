(function () {
  function codehemucolor(color, elmnt) {
    if (!(this instanceof codehemucolor)) {
      return new codehemucolor(color, elmnt);
    }
  ...
  window.codehemucolor = codehemucolor;
...
function w3SetColorsByAttribute() {
  ...
  for (i = 0; i < z.length; i++) {
    ...
    if (att) {
      z[i].style.backgroundColor = codehemucolor(att).toRgbString();
    }
  }
}